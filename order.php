				...
				<tbody>
					...
					<tr>
						...
						while ($DonneesListeLigneDucommande = $req->fetch()){
							...
							<tr>
								<td><input type="hidden" name="UpdateIdLignecommande[]" id="UpdateIdLignecommande" value="'. $DonneesListeLigneDucommande['Id'] .'"><a href="order.php?id='. $_GET['id'] .'&amp;delete='. $DonneesListeLigneDucommande['Id'] .'" title="Supprimer la ligne">x</a></td>
