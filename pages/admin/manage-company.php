<?php 
	...
	while ($donnees_Mail = $req->fetch()){
		 $contenu3 = $contenu3 .'
				<tr>
					<td></td>
					<td><a href="admin.php?page=manage-company&mail='. $donnees_Mail['Id'] .'">'. $donnees_Mail['CODE'] .'</a></td>
					<td><a href="admin.php?page=manage-company&mail='. $donnees_Mail['Id'] .'">'. $donnees_Mail['LABEL'] .'</a></td>
					<td><a href="admin.php?page=manage-company&mail='. $donnees_Mail['Id'] .'">'. $donnees_Mail['OBJET'] .'</a></td>
	...
	while ($donnees_TimeLine = $req->fetch()){
		...
		if($donnees_TimeLine['ETAT'] == 0){$EtatTimeLine = "Non publiée";}
		 ...
		 $contenu5 = $contenu5 .'
				<tr>
					<td></td>
					<td><a href="admin.php?page=manage-company&timeline='. $donnees_TimeLine['Id'] .'">'. $EtatTimeLine .'</a></td>
					<td><a href="admin.php?page=manage-company&timeline='. $donnees_TimeLine['Id'] .'">'. extrait($donnees_TimeLine['TEXT']) .'</a></td>
					<td><a href="admin.php?page=manage-company&timeline='. $donnees_TimeLine['Id'] .'">'. format_temps($donnees_TimeLine['TIMESTAMP']) .'</a></td>
				</tr>';
		$i++;
	}
