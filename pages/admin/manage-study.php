<?php 
	...
	$actionForm = 'admin.php?page=manage-study';
	...
	if(isset($_POST['CODEArticle']) AND isset($_POST['LABELAtricle']) AND !empty($_POST['CODEArticle']) AND !empty($_POST['LABELAtricle']) OR  isset($_GET['id']) AND !empty($_GET['id'])){
		...
		$actionForm = 'admin.php?page=manage-study&id='. $ArticleLabel .'';
	}
		...
		while ($donnees_SousEns = $req->fetch()){
			 $SousEnsemble .= '
					<tr>
						...
						<td><a href="admin.php?page=manage-study&id='. $donnees_SousEns['LABEL_ARTICLE'] .'">--></a></td>
					</tr>';
